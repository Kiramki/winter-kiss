...
screen main_menu():
    ...
    add "gui/overlay/main_menu_logo.png" xpos -100
    add "gui/logo/game_menu_logo.png" xpos 410 ypos 225 xanchor 0.5 yanchor 0.5

    #text "[config.name!t]" size 35 xpos 501 ypos 225 xanchor 0.5 yanchor 0.5 color u"#ffffff"
